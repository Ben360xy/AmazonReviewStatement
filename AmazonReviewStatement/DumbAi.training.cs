...
namespace AmazonReviewStatement
{
    public partial class DumbAi
    {
        public const string RetrainFilePath =  @"C:\Users\benrv\Downloads\train-reviews-micro - train-reviews-micro (1).csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"sentiment",inputColumnName:@"sentiment",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"sentiment", sentence1ColumnName: @"review_text"))      
